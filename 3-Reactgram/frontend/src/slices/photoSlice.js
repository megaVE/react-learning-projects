    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(updatePhoto.fulfilled, (state, action) => {
                ...
                state.success = true
                state.error = null
                state.photos.map(photo => photo._id === action.payload.photo._id ? (photo.title = action.payload.photo.title) : photo)
                state.message = action.payload.message
            })
            ...
            .addCase(like.fulfilled, (state, action) => {
                ...
                state.photos.map(photo => photo._id === action.payload.photoId ? (photo.likes.push(action.payload.userId)) : photo)
                state.message = action.payload.message
            })
